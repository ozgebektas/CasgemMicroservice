    ...
    public static class Config
    {
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
              ...
              new ApiScope("photostock_fullpermission","Fotograf islemleri için tam erişim"),
              new ApiScope("basket_fullpermission","Fotograf islemleri için tam erişim"),
              new ApiScope("discount_fullpermission","Kuponlar islemleri için tam erişim"),
